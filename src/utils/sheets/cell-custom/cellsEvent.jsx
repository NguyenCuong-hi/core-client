...
export const Editor = (p) => {
  ...
  const filteredData = useMemo(() => {
    ...
    const propertiesToSearch = ["eventCode", "eventName",];
...
export const CellsEvent = {
  kind: GridCellKind.Custom,
  isMatch: (c) => c.data.kind === 'cells-event',
  draw: (args, cell) => {
...
export const callGetCodeHelp = async (key, d) => {
  ...
  try {
    ...
    const result = await eventSearchBy(searchData);
