...
function CategoryTable({
  ...
  const [hiddenColumns, setHiddenColumns] = useState(() => {
    return loadFromLocalStorageSheet('H_ERP_COLS_PAGE_CATEGORY', []);
  });
  ...
  const updateHiddenColumns = (newHiddenColumns) => {
    setHiddenColumns((prevHidden) => {
      ...
      saveToLocalStorageSheet('H_ERP_COLS_PAGE_CATEGORY', newHidden);
      return newHidden;
    });
  };
  ...
  const updateVisibleColumns = (newVisibleColumns) => {
    setCols((prevCols) => {
      ...
      saveToLocalStorageSheet('S_ERP_COLS_PAGE_CATEGORY', uniqueCols);
      return uniqueCols;
    });
  };
  // Hàm ẩn cột
  ...
  const handleReset = () => {
    ...
    setHiddenColumns([]);
    localStorage.removeItem('S_ERP_COLS_PAGE_CATEGORY');
    localStorage.removeItem('H_ERP_COLS_PAGE_CATEGORY');
    setShowMenu(null);
  };
  ...
  const onColumnMoved = useCallback((startIndex, endIndex) => {
    setCols((prevCols) => {
      ...
      saveToLocalStorageSheet('S_ERP_COLS_PAGE_CATEGORY', updatedCols);
      return updatedCols;
    });
  }, []);
  ...
  const showDrawer = () => {
    ...
    const currentVisibleCols = loadFromLocalStorageSheet('S_ERP_COLS_PAGE_CATEGORY', []).map((col) => col.id);
  ...
  const handleCheckboxChange = (columnId, isChecked) => {
    if (isChecked) {
      ...
      setCols((prevCols) => {
        ...
        saveToLocalStorageSheet('S_ERP_COLS_PAGE_CATEGORY', newCols);
        return newCols;
      });
      setHiddenColumns((prevHidden) => {
