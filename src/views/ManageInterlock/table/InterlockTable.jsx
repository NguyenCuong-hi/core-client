...
function InterlockTable({
  ...
  const [hiddenColumns, setHiddenColumns] = useState(() => {
    return loadFromLocalStorageSheet('H_INTERLOCK', []);
  });
  ...
  const updateHiddenColumns = (newHiddenColumns) => {
    setHiddenColumns((prevHidden) => {
      ...
      saveToLocalStorageSheet('H_INTERLOCK', newHidden);
      return newHidden;
    });
  };
  ...
  const updateVisibleColumns = (newVisibleColumns) => {
    setCols((prevCols) => {
      ...
      saveToLocalStorageSheet('S_INTERLOCK', uniqueCols);
      return uniqueCols;
    });
  };
  // Hàm ẩn cột
  ...
  const handleReset = () => {
    ...
    setHiddenColumns([]);
    localStorage.removeItem('S_INTERLOCK');
    localStorage.removeItem('H_INTERLOCK');
    setShowMenu(null);
  };
  ...
  const onColumnMoved = useCallback((startIndex, endIndex) => {
    setCols((prevCols) => {
      ...
      saveToLocalStorageSheet('S_INTERLOCK', updatedCols);
      return updatedCols;
    });
  }, []);
  ...
  const showDrawer = () => {
    ...
    const currentVisibleCols = loadFromLocalStorageSheet('S_INTERLOCK', []).map((col) => col.id);
  ...
  const handleCheckboxChange = (columnId, isChecked) => {
    ...
    if (isChecked) {
      ...
      setCols((prevCols) => {
        ...
        saveToLocalStorageSheet('S_INTERLOCK', newCols);
        return newCols;
      });
      setHiddenColumns((prevHidden) => {
