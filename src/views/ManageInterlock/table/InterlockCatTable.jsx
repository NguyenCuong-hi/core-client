...
function InterlockCatTable({
  ...
  const [hiddenColumns, setHiddenColumns] = useState(() => {
    return loadFromLocalStorageSheet('H_EVENT', []);
  });
  ...
  const updateHiddenColumns = (newHiddenColumns) => {
    setHiddenColumns((prevHidden) => {
      ...
      saveToLocalStorageSheet('H_EVENT', newHidden);
      return newHidden;
    });
  };
  ...
  const updateVisibleColumns = (newVisibleColumns) => {
    setCols((prevCols) => {
      ...
      saveToLocalStorageSheet('S_EVENT', uniqueCols);
      return uniqueCols;
    });
  };
  // Hàm ẩn cột
  ...
  const handleReset = () => {
    ...
    setHiddenColumns([]);
    localStorage.removeItem('S_EVENT');
    localStorage.removeItem('H_EVENT');
    setShowMenu(null);
  };
  ...
  const onColumnMoved = useCallback((startIndex, endIndex) => {
    setCols((prevCols) => {
      ...
      saveToLocalStorageSheet('S_EVENT', updatedCols);
      return updatedCols;
    });
  }, []);
  ...
  const showDrawer = () => {
    ...
    const currentVisibleCols = loadFromLocalStorageSheet('S_EVENT', []).map((col) => col.id);
  ...
  const handleCheckboxChange = (columnId, isChecked) => {
    if (isChecked) {
      ...
      setCols((prevCols) => {
        ...
        saveToLocalStorageSheet('S_EVENT', newCols);
        return newCols;
      });
      setHiddenColumns((prevHidden) => {
...
export default InterlockCatTable;
