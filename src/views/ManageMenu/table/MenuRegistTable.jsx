...
function MenuRegistTable({
  ...
  const showDrawer = () => {
    ...
    const currentVisibleCols = loadFromLocalStorageSheet('S_ERP_COLS_PAGE_MENU', []).map((col) => col.id);
...
export default MenuRegistTable;
