...
import { DeleteOutlined, FilterOutlined, SaveOutlined, SwitcherFilled, SwitcherOutlined, ThunderboltOutlined } from '@ant-design/icons';

const onSearch = (value) => {
  console.log(value);
};

const AuDMachineToolAction = ({
  keyword,
  setKeyword,
  onClickSave,
  onClickUpdate,
...
export default AuDMachineToolAction;
