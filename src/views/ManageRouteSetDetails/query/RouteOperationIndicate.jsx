...
import OperationIndicateTable from '../table/OperationIndicateTable';

const RouteOperationIndicateQuery = ({
  defaultCols,
  gridData,
  setGridData,
  cols,
  ...
  return (
    <div className="bg-slate-50 rounded-md overflow-auto mb-2 pb-2">
      <Typography.Title className="border-b-1 uppercase border-gray-400 m-2" style={{ fontSize: 'medium', color: '#6b7280' }}>
        Đăng ký thông tin hiệu suất
      </Typography.Title>
      <div className="bg-slate-50 rounded-md h-96 ">
        <OperationIndicateTable
...
export default RouteOperationIndicateQuery;
